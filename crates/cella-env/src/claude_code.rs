...
/// recursively; any non-object patch replaces `base` wholesale. This is the
/// deletion-aware counterpart to [`merge_claude_config`], which is a pure
/// additive merge and cannot express a removal.
#[must_use]
